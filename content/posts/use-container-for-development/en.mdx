...
Minikube runs a kubernetes cluster in a virtual machine. To make sure the consistency across different OS, virtualbox is the best VM driver in this case. But if the host machine is too old to run virtual machines, the none driver comes to rescue.
