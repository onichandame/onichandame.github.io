...
This section records the practices I exercised based on the principles.

## Choice of Service Provider

The key component in the chain is the reverse proxy. Normally a cloud service provider is the best choice as it has all the functionalities we need out of the box.
